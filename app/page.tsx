...
import { faTwitter, faGithub, faInstagram, faFontAwesome } from '@fortawesome/free-brands-svg-icons'
      ...
      <div className="columns is-vcentered">
        ...
        <div className="column is-size-4">
          ...
          <div className="mt-5 pt-3">
            <a href="https://twitter.com/siangliulue" className="button is-primary is-rounded mr-2 mt-2" target="_blank">
              <FontAwesomeIcon icon={faTwitter as IconProp} size="xs" />&nbsp;Twitter
            </a>
            <a href="https://github.com/paopow" className="button is-primary is-rounded mr-2 mt-2" target="_blank">
              <FontAwesomeIcon icon={faGithub as IconProp} size="xs" />&nbsp;Github
            </a>
            <a href="https://www.semanticscholar.org/author/Pao-Siangliulue/3061428" className="button is-primary is-rounded mr-2 mt-2" target="_blank">
